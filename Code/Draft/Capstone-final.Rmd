...
bring in the data and name it DOG for fun
...
we reject the hypothesis as there is no significant difference between any of the values. 
...
ggplot(DOG, aes(x = Fixed, y = Excite)) + geom_boxplot() + geom_point(size = 4, color = 'lightgrey', alpha = 0.5)
```
